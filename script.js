...
async function buy_chicken() {
  if (money >= chicken_cost) {
    ...
    chicken_cost += Math.round(Math.sqrt(chicken_cost/1.25)) + (chicken_cost/10)
...
async function buy_duck() {
  if (money >= duck_cost) {
    ...
    duck_cost += Math.round(Math.sqrt(duck_cost/1.15)) + (duck_cost/10)
...
async function buy_cow() {
  if (money >= cow_cost) {
    ...
    cow_cost += Math.round(Math.sqrt(cow_cost/1.05)) + (cow_cost/10)
